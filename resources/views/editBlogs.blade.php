                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-vertical" method="POST" action="{{route('updblog',$blogs->id)}}--}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="tittle" name="tittle" value="{{$blogs->tittle}}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="description"
                                                                  name="description"
                                                                  rows="3">{{$blogs->description}}</textarea>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <p>Profile Image</p>
                                                        <label for="file"><img src="../{{asset('assets/images/blog_images/'. $blogs->image)}}" id="image"></label>
                                                        <input type="file" class="d-none" id="file" name="image" onchange="loadImage(event)">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <p>Banner Image</p>
                                                        <label for="file2"><img src="../{{asset('assets/images/blog_images/'. $blogs->image_profile)}}" id="image2"></label>
                                                        <input type="file" class="d-none" id="file2" name="image2" onchange="loadImage2(event)">
                                                    </div>
                                                </div>
