                    ...
                    <div class="col-12 col-md-6 order-md-2 order-first">
                        <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('certificatesAdmin')}}">Certificates</a></li>
                            </ol>
                        </nav>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 col-12">
                        <div class="card">
                            <div class="card-content">
                                <div class="card-body">
                                    <form class="form form-vertical" method="POST" action="{{route('updCertificate',$certificates->id)}}" enctype="multipart/form-data">
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="file"><img
                                                                src="../{{asset('assets/images/gallery/'. $certificates->path)}}"
                                                                id="image" style="width: 60%;"></label>
